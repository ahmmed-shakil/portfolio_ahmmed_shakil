...
import randomColorGeneratorImage from "../../../../images/Projects/color-generator.png";
import counterImage from "../../../../images/Projects/counter.png";
import carehubImage from "../../../../images/Projects/carehub.png";
import pandaImage from "../../../../images/Projects/panda.png";
...
const Projects = () => {
  const types = [
      ...
      items: [
        {
          ...
          links: [
            {
              title: "View",
              href: "https://carehub-clinic.web.app/",
              icon: (
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            {
              title: "Code",
              href: "https://github.com/ahmmed-shakil/care-hub",
              icon: (
                <svg
                  stroke="currentColor"
                  fill="currentColor"
    ...
    },
    {
      ...
      items: [
        {
          image: randomColorGeneratorImage,
          title: "Random Color Generator",
          desc: "It is a random color generator which will generate a random hex or rgb color and the user can copy that color code. It was built using DOM manipulation by JavaScript",
          links: [
            {
              title: "View",
              href: "https://ahmmed-shakil.github.io/random-color-generator/",
              icon: (
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            {
              title: "Code",
              href: "https://github.com/ahmmed-shakil/random-color-generator",
              icon: (
                <svg
                  stroke="currentColor"
                  fill="currentColor"
...

        {
          image: counterImage,
          title: "Counter",
          desc: "Simple counter made with DOM manipulation using javascript. It saves the counter value on local storage and shows the time when the counter value was updated",
          links: [
            {
              title: "View",
              href: "https://ahmmed-shakil.github.io/js-counnter/",
              icon: (
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            {
              title: "Code",
              href: "https://github.com/ahmmed-shakil/js-counnter",
              icon: (
                <svg
                  stroke="currentColor"
                  fill="currentColor"
        ...
        },
        {
          ...
          desc: "A static e-commerce website layout built with html, css and javascript. Bootstrap was used as the css framework",
          links: [
            {
              title: "View",
              href: "https://ahmmed-shakil.github.io/panda-commerce-bootstrap/",
              icon: (
                <svg
                  stroke="currentColor"
                  fill="currentColor"
            ...
            {
              title: "Code",
              href: "https://github.com/ahmmed-shakil/panda-commerce-bootstrap",
              icon: (
                <svg
                  stroke="currentColor"
                  fill="currentColor"
