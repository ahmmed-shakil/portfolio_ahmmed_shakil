    ...
    >
      ...
      <div className=" p-3 space-y-1 grid grid-rows-subgrid row-span-3">
        ...
        <div className=" flex justify-between gap-3 items-center py-1">
          {data.liveLink ? (
            <div className=" flex justify-start gap-1 items-center py-0 my-0 hover:underline hover:text-primary cursor-pointer">
              <svg
                stroke="currentColor"
                fill="currentColor"
                stroke-width="0"
              ...
              <Typography className=" text-md py-0 my-0">View</Typography>
            </div>
          ) : null}
          {data?.clientLink ? (
            <div className=" flex justify-start gap-1 items-center py-0 my-0 hover:underline hover:text-primary cursor-pointer">
              ...
              <Typography className=" text-md py-0 my-0">Client</Typography>
            </div>
          ) : null}
          {data?.serverLink ? (
            <div className=" flex justify-start gap-1 items-center py-0 my-0 hover:underline hover:text-primary cursor-pointer">
              ...
              <Typography className=" text-md py-0 my-0">Server</Typography>
            </div>
          ) : null}
        </div>
        <p
