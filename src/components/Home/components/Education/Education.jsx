      ...
      <Layout>
        <div className=" space-y-10 px-5 pt-0">
          ...
          <div className="space-y-2 md:space-y-10 text-third">
            <div className=" grid grid-cols-1 md:grid-cols-background w-full md:w-2/5 mx-auto items-start">
              ...
              <div>
                ...
                <div>
                  ...
                  <Typography className=" text-sm font-semibold mt-0 pt-0">
                    ...
                    Modeling, PostgreSQL, Prisma, Linux, Docker, Docker Compose,
                    CI/CD, Deployment on AWS, AWS S3, CloudFront, EC2, Amplify,
                    Server Setup, Reverse Proxy, Load Balancing using Nginx,
                    Testing (Unit & Integration), Cypress for End-to-End
                    Testing, API Testing with Jest & Supertest, Testing React
                    with React Testing Library & Vitest, GraphQL, Secure API
                    Creation and Optimize Performance, Apollo-Client, Task
                    breakdown technique & SDLC, Project management tools
                  </Typography>
                </div>
              </div>
            </div>
